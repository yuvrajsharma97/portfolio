  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
      <div
        ...
        className="bg-gray-800 p-8 rounded-lg shadow-lg w-11/12 md:w-3/4 lg:w-2/3 max-h-[90vh] overflow-hidden flex flex-col">
        {/* Modal Header */}
        <div className="flex justify-between items-center border-b pb-2">
          ...
          <button
            onClick={onClose}
            className="text-gray-600 cursor-pointer text-gray-300 hover:text-gray-900 hover:text-white text-2xl">
            &times;
          </button>
        </div>

        {/* Modal Content with Custom Scrollbar */}
        <div className="text-gray-800 text-gray-300 overflow-y-auto min-h-96 p-4 custom-scrollbar">
          {children}
        </div>
      </div>
    </div>
